...
| **次にやること** | P3-04(クラス設計・バックエンド)から着手。ロジック仕様3本(P3-01〜03)は完了・中間レビュー済み |
| **開始日** | 2026-08-22 |
...
- **タスクの見積もりを出す前に、内容の複雑さより先に「これはKazukiが実際に書く/調べるのか、Claudeが全文ドラフトしKazukiは意思決定のみか」を必ず自問する。後者なら、内容がどれだけ目新しく複雑に見えても合意値を通常の0.3〜0.5倍程度に下げる。**(2026-08-29、P3-01 合意値3.0hに対し実績0.75h・-75%、P3-03 合意値1.25hに対し実績0.75h・-40%。前回セッションで全く同じ教訓[P2.5-06]を明文化していたにもかかわらず、「疑似コード執筆という初めての内容」という目新しさに引きずられて適用し忘れた。打ち手を知っていることと、見積もりの瞬間に思い出して適用することは別問題)
